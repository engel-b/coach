...
export function adaptiveWorkoutPresentation(
  ...
  const text = {
    ...
    extend_warmup: advice.planReflectsAdvice
      ? "Die ruhige Aufwärmphase wurde um zwei Minuten verlängert; die Gesamtdauer bleibt gleich."
      : "Für ein längeres Aufwärmen ist die heutige Einheit zu kurz; fahre bei Bedarf länger locker ein.",
    prefer_recovery:
